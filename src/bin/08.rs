...
pub fn part_one(input: &str) -> Option<u32> {
    ...
    Some(calculate_antinodes(map_size, antennas))
}
...
fn calculate_antinodes(map_size: MapSize, antennas: Antennas) -> u32 {
...
#[allow(unused)]
fn debug_map(map_size: MapSize, antennas: &Antennas, antinodes: Option<&Antinodes>) {
